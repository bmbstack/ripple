...
func (*GetInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1b411f6a836508a, []int{0}
}
...
func (*GetInfoReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1b411f6a836508a, []int{1}
}
...
func (*SayHelloReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1b411f6a836508a, []int{2}
}
...
func (*SayHelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1b411f6a836508a, []int{3}
}
...
func init() {
	proto.RegisterFile("cmd/ripple/templates/proto/user.proto", fileDescriptor_f1b411f6a836508a)
}

var fileDescriptor_f1b411f6a836508a = []byte{
	// 210 bytes of a gzipped FileDescriptorProto
	,
}
...
// Gernerated from cmd/ripple/templates/proto/user.proto
...
func newXClientForUser() (client.XClient, error) {
	...
	d, err := client1.NewNacosDiscovery(ServiceNameOfUser, "", "", clientConfig, serverConfig)
	if err != nil {
		return nil, err
	}
...
func NewUserClient() *UserClient {
	...
	if err != nil {
		fmt.Println(fmt.Sprintf("Create rpcx client err: ", err.Error()))
		return &UserClient{}
	}
