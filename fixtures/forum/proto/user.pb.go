...
func (*GetInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a27d7039c4a7c66, []int{0}
}
...
func (*GetInfoReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a27d7039c4a7c66, []int{1}
}
...
var fileDescriptor_0a27d7039c4a7c66 = []byte{
	...
	0xa4, 0x44, 0x30, 0xc4, 0xc0, 0xfa, 0x8c, 0x4a, 0xb8, 0x58, 0xfd, 0x8b, 0x52, 0xe8, 0x6c, 0xab,
	0x93, 0xc0, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe3,
	0xb1, 0x1c, 0x43, 0x12, 0x1b, 0x58, 0xa1, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x81, 0x4f, 0x26,
	0xb9, 0xb3, 0x01, 0x00, 0x00,
}
...
// Gernerated from fixtures/forum/proto/user.proto
...
func newXClientForUser() (client.XClient, error) {
	...
	d, err := client1.NewNacosDiscovery(ServiceNameOfUser, "orderserver", "DEFAULT_GROUP", clientConfig, serverConfig)
	if err != nil {
		return nil, err
	}
...
const ServiceNameOfOrder = "OrderRpc"

//================== interface ===================
type OrderInterface interface {

	// OrderInterface can be used for interface verification.
	// GetInfo is server rpc method as defined
	GetInfo(ctx context.Context, req *GetInfoReq, reply *GetInfoReply) (err error)
...
//================== server implement demo ===================
//ripple.Default().RegisterRpc("User", &UserRpcDemo{}, "")
type OrderRpcDemo struct{}

func (this *OrderRpcDemo) GetInfo(ctx context.Context, req *GetInfoReq, reply *GetInfoReply) (err error) {
	// TODO: add business logics
	*reply = GetInfoReply{}
	return nil
}

func (this *OrderRpcDemo) SayHello(ctx context.Context, req *SayHelloReq, reply *SayHelloReply) (err error) {
	// TODO: add business logics
	*reply = SayHelloReply{}
	return nil
}
...
//================== client stub ===================
// newXClientForOrder creates a XClient.
// You can configure this client with more options such as etcd registry, serialize type, select algorithm and fail mode.
func newXClientForOrder() (client.XClient, error) {
	config := ripple.GetBaseConfig()
	if helper.IsEmpty(config.Nacos) {
		return nil, errors.New("yaml nacos config is null")
	}
	...
	d, err := client1.NewNacosDiscovery(ServiceNameOfOrder, "orderserver", "DEFAULT_GROUP", clientConfig, serverConfig)
	if err != nil {
		return nil, err
	}
	...
	xclient := client.NewXClient(ServiceNameOfOrder, client.Failtry, client.RoundRobin, d, opt)

	return xclient, nil
}

// Order is a client wrapped XClient.
type OrderClient struct {
	xclient client.XClient
}

// NewOrderClient wraps a XClient as OrderClient.
// You can pass a shared XClient object created by NewXClientForOrder.
func NewOrderClient() *OrderClient {
	xc, err := newXClientForOrder()
	if err != nil {
		fmt.Println(fmt.Sprintf("Create rpcx client err: orderserver", err.Error()))
		return &OrderClient{}
	}
	return &OrderClient{xclient: xc}
}

// GetInfo is client rpc method as defined
func (c *OrderClient) GetInfo(ctx context.Context, req *GetInfoReq) (reply *GetInfoReply, err error) {
	reply = &GetInfoReply{}
	err = c.xclient.Call(ctx, "GetInfo", req, reply)
	return reply, err
}
...
// SayHello is client rpc method as defined
func (c *OrderClient) SayHello(ctx context.Context, req *SayHelloReq) (reply *SayHelloReply, err error) {
	reply = &SayHelloReply{}
	err = c.xclient.Call(ctx, "SayHello", req, reply)
	return reply, err
}
