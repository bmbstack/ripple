...
func (m *MockINamingProxy) DeregisterInstance(serviceName, groupName string, instance model2.Instance) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockINamingProxy) GetServiceList(pageNo, pageSize uint32, groupName string, selector *model2.ExpressionSelector) (model2.ServiceList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServiceList", pageNo, pageSize, groupName, selector)
	ret0, _ := ret[0].(model2.ServiceList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockINamingProxy) QueryInstancesOfService(serviceName, groupName, clusters string, udpPort int, healthyOnly bool) (*model2.Service, error) {
	m.ctrl.T.Helper()
...
func (m *MockINamingProxy) RegisterInstance(serviceName, groupName string, instance model2.Instance) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockINamingProxy) Subscribe(serviceName, groupName, clusters string) (model2.Service, error) {
	m.ctrl.T.Helper()
