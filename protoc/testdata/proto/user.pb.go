...
func (m *SayHelloReq) GetNum() uint64 {
	if m != nil {
		return m.Num
	}
	return 0
...
func (m *SayHelloReply) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
var fileDescriptor_d570e3e37e5899c5 = []byte{
	...
	,
}
...
func (m *SayHelloReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Num != 0 {
		i = encodeVarintUser(dAtA, i, uint64(m.Num))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
