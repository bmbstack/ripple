...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	,
}
...
// Gernerated from user.proto

const ServiceNameOfUser = "User"
...
func newXClientForUser() (client.XClient, error) {
	...
	d, err := client1.NewNacosDiscovery(ServiceNameOfUser, config.Nacos.Cluster, config.Nacos.Group, clientConfig, serverConfig)
	if err != nil {
		return nil, err
	}
